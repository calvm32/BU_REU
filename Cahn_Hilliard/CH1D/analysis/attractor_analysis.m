...
%% Description
% Try to perform omega-limiting of the bounding H1 ball
% get a bundle of points in that ball
% compare the omega-limit set = A(t) = PBA at time t, with actual solution
