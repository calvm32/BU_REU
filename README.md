...
where $\mu$ is a parameter slowly varying with time and $t_0 < 0$. In Section \ref{sec:whitham_SH}, we will show that this is derived from the following 2D Swift-Hohenberg equation (SH):
